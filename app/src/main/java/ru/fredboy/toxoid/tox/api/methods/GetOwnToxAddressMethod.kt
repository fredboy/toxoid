...
) : ToxServiceApiMethod<ToxServiceGetOwnAddressArgs, ToxServiceGetOwnAddressResult>(args) {

    override suspend fun execute(toxCore: ToxCore): ToxServiceGetOwnAddressResult {
