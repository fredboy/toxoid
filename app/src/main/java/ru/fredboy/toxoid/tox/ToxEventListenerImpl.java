...
class ToxEventListenerImpl implements ToxCoreEventListener<Object> {
    ...
    @Override
    public Object fileChunkRequest(int friendNumber, int fileNumber, long position, int length, Object state) {
        Log.d(TAG, "fileChunkRequest: ");
        return new Object();
    }

    @Override
    public Object fileRecv(int friendNumber, int fileNumber, int kind, long fileSize, byte[] filename, Object state) {
        Log.d(TAG, "fileRecv: ");
        return new Object();
    }

    @Override
    public Object fileRecvChunk(int friendNumber, int fileNumber, long position, byte[] data, Object state) {
        Log.d(TAG, "fileRecvChunk: ");
        return new Object();
    }

    @Override
    public Object fileRecvControl(int friendNumber, int fileNumber, ToxFileControl control, Object state) {
        Log.d(TAG, "fileRecvControl: ");
        return new Object();
    }

    @Override
    public Object friendConnectionStatus(int friendNumber, ToxConnection connectionStatus, Object state) {
    ...
    @Override
    public Object friendMessage(int friendNumber, ToxMessageType messageType, int timeDelta, byte[] message, Object state) {
